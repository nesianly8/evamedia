        ...
        <div class="form-container">
            <form>
                <div class="cover-height">
                    <label for="title-content" class="title-content form-label">Berita</label>
                    <div class="mask-group">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="email" class="form-control" id="exampleFormControlInput1" placeholder="Masukan Judul Berita"></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="my-editor subtitle-content">ARTIKEL BERITA</label>
                            <input id="my-editor" type="hidden" name="content">
                            <trix-editor input="my-editor"></trix-editor>
                        </div>
                    </div>
                    <label for="title-content" class="title-content form-label">Kategori Berita</label>
                    <div class="mask-group">
                        <label for="exampleFormControlInput1 subtitle-content" class="form-label">TAGS BERITA</label>
                        <div class="mb-3">
                            <select class="form-select" id="multiple-select-optgroup-field" data-placeholder="TECHNOLOGY" style="background-color: #FAFAFA !important;" multiple>
            ...
            <form>
                <div class="cover-height">
                    <div class="form-group">
                        <label for="title-content" class="title-content form-label">Upload</label>
                        <div class="mask-group">
                            <div class="row mb-3">
                                <div class="col-lg-6">
                                    <label for="exampleSelect subtitle-content">STATUS</label>
                                ...
                                <div class="col-lg-6">
                                    <label for="exampleSelect subtitle-content">DILIHAT UNTUK</label>
                                    <select class="form-control" id="exampleSelect" @readonly(true)>
                    ...
                    <div class="">
                        <label for="title-content" class="title-content form-label">Gallery Berita </label>
                        <div class="mask-group">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header d-flex justify-content-center w-50 ">
                    <img src="evamedia-asset/tabel/icon.png" alt="">
                </div>
