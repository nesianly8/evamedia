...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-6 col-lg-6 col-xl-6">
                    <div class="content-img w-100">
                        <img src="{{ $baseurl }}public/evamedia-asset/home/evamedia-img-hero.png" alt=""
                            srcset="" class="w-100">
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-12 col-lg-12">
                                        <div class="icon-service">
                                            <img src="{{ $baseurl }}public/evamedia-asset/home/{{ $baseService[$i]['icon'] }}"
                                                alt="" class="w-25">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-12 col-lg-12">
    ...
    <section class="py-5 desktop-show" id="tools">
        <div class="list-img-tools infinite-slider d-flex w-100" id="list-img-tools" style="white-space: nowrap;">
            ...
            @for ($idx = 0; $idx < 3; $idx++) <!-- comment -->
                ...
                @for ($i = 0; $i < count($baseTools); $i++)
                    <!-- comment -->
                    <img src="{{ $baseurl }}public/evamedia-asset/home/{{ $baseTools[$i]['img'] }}" alt=""
                        srcset="" class="w-img1 h-100 px-3">
                    <!-- <div class="col-3 col-md-3 col-lg-3">
              </div> -->
                @endfor
                <!-- </div> -->
                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12 text-center">
                        ...
                        <p class="c-696687 mb-0">
                            ...
                            We are proud to present our work results that reflect the dedication of innovative designs and
            ...
            <div class="list-card-service mt-5" id="graphicDesign">
                ...
                <div class="card-list pb-2 ovr-flow-x-auto">
                    <div class="d-flex">
                        ...
                        @for ($idx = 0; $idx < count($baseGD); $idx++)
                            <!-- comment -->
                            <div class="col-3 col-md-3 col-lg-3">
                                <!-- <div class="card-item w-25 px-3"> -->
                                <div class="card-item px-3 open-modal" data-toggle="modal"
                                    data-target="#myModal{{ $idx }}">
                                    <div class="row">
                                        <div class="col-12 col-md-12 col-lg-12">
                                            <div class="cover-card">
                                                <div class="img-cover">
                                                    <img src="{{ $baseurl }}public/evamedia-asset/home/{{ $baseGD[$idx]['cover'] }}"
                                        ...
                                        <div class="content-card d-flex justify-content-between mt-2">
                                            <div class="creator-content">
                                                <p class="fs-desc1 mb-0">
                                                    <span class="c-696687">by</span> <span
                                                        class="fw-700">{{ $baseGD[$idx]['created_by'] }}</span>
                                                </p>
                                            </div>
            ...
            <div class="list-card-service mt-5" id="uiuxDesign">
                ...
                <div class="card-list pb-2 ovr-flow-x-auto">
                    <div class="d-flex">
                        ...
                        <!-- <div class="row"> -->
                        {{-- @for ($index = 0; $index < 5; $index++) <!-- comment --> --}}
                        @for ($idx = 0; $idx < count($baseUIUX); $idx++)
                            <!-- comment -->
                            <div class="col-3 col-md-3 col-lg-3">
                                <!-- <div class="card-item w-25 px-3"> -->
                                <div class="card-item px-3">
                                    <div class="row">
                                        <div class="col-12 col-md-12 col-lg-12">
                                            <div class="cover-card">
                                                <div class="img-cover">
                                                    <img src="{{ $baseurl }}public/evamedia-asset/home/{{ $baseUIUX[$idx]['cover'] }}"
                                                        alt="" srcset="" class="w-100">
                                                </div>
                                                <!-- <div class="text-cover"> -->
                                                <!-- <p> -->
                                        ...
                                        <div class="content-card d-flex justify-content-between mt-2">
                                            <div class="creator-content">
                                                <p class="fs-desc1 mb-0">
                                                    <span class="c-696687">by</span> <span
                                                        class="fw-700">{{ $baseUIUX[$idx]['created_by'] }}</span>
                                                </p>
                                            </div>
                                            <div class="date-content">
                                                <p class="fs-desc1 mb-0">
    ...
    <section class="py-0 bg-separate-section desktop-show" id="separateContent">
        ...
        <div class="content-separator d-flex justify-content-center align-items-end pos-relative z-index-2">
            <img src="{{ $baseurl }}public/evamedia-asset/home/evamedia-agancy-girl.png" alt=""
                srcset="" class="w-75">
            ...
            <div class="list-card-service" id="videoEditing">
                ...
                <div class="card-list pb-2 ovr-flow-x-auto">
                    <div class="d-flex">
                        ...
                        <!-- <div class="row"> -->
                        {{-- @for ($index = 0; $index < 5; $index++) <!-- comment --> --}}
                        @for ($idx = 0; $idx < count($baseVE); $idx++)
                            <!-- comment -->
                            <div class="col-3 col-md-3 col-lg-3">
                                <!-- <div class="card-item w-25 px-3"> -->
                                <div class="card-item px-3">
                                    <div class="row">
                                        <div class="col-12 col-md-12 col-lg-12">
                                            <div class="cover-card">
                                                <div class="img-cover">
                                                    <img src="{{ $baseurl }}public/evamedia-asset/home/{{ $baseVE[$idx]['cover'] }}"
                                                        alt="" srcset="" class="w-100">
                                                </div>
                                            </div>
                                            <!-- <div class="text-cover "> -->
                                        ...
                                        <div class="content-card d-flex justify-content-between mt-2">
                                            <div class="creator-content">
                                                <p class="fs-desc1 mb-0">
                                                    <span class="c-696687">by</span> <span
                                                        class="fw-700">{{ $baseVE[$idx]['created_by'] }}</span>
                                                </p>
                                            </div>
                                            <div class="date-content">
                                                <p class="fs-desc1 mb-0">
            ...
            <div class="list-card-service mt-5" id="socialMedia">
                ...
                <div class="card-list pb-2 ovr-flow-x-auto">
                    <div class="d-flex">
                        ...
                        <!-- <div class="row"> -->
                        {{-- @for ($index = 0; $index < 5; $index++) <!-- comment --> --}}
                        @for ($idx = 0; $idx < count($baseSMH); $idx++)
                            <!-- comment -->
                            <div class="col-3 col-md-3 col-lg-3">
                                <!-- <div class="card-item w-25 px-3"> -->
                                <div class="card-item px-3">
                                    <div class="row">
                                        <div class="col-12 col-md-12 col-lg-12">
                                            <div class="cover-card">
                                                <div class="img-cover">
                                                    <img src="{{ $baseurl }}public/evamedia-asset/home/{{ $baseSMH[$idx]['cover'] }}"
                                                        alt="" srcset="" class="w-100">
                                                </div>
                                                <!-- <div class="text-cover"> -->
                                                <!-- <p> -->
                                        ...
                                        <div class="content-card d-flex justify-content-between mt-2">
                                            <div class="creator-content">
                                                <p class="fs-desc1 mb-0">
                                                    <span class="c-696687">by</span> <span
                                                        class="fw-700">{{ $baseSMH[$idx]['created_by'] }}</span>
                                                </p>
                                            </div>
                                            <div class="date-content">
                                                <p class="fs-desc1 mb-0">
                        ...
                        <div class="row">
                            <div class="col-6 col-md-6 col-lg-6">
                                <div class="content-image ">
                                    <img src="{{ $baseurl }}public/evamedia-asset/home/evamedia-img-form.png"
                                        alt="" class="w-100">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-6 col-md-6 col-lg-6">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" name="name" class="form-control input-form-transparent"
                            ...
                            <div class="col-6 col-md-6 col-lg-6">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="email" name="email" class="form-control input-form-transparent"
                                        id="floatingInput" placeholder="" required>
                            ...
                            <div class="col-12 col-md-12 col-lg-12">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="tel" name="telp" class="form-control input-form-transparent"
    ...
    @foreach ($baseGD as $idx => $item)
        <section class="py-5 bg-form-img desktop-show" id="formSendMailMob" style="">
            <div class="modal fade" id="myModal{{ $idx }}" data-bs-backdrop="static" data-bs-keyboard="false"
                tabindex="-1" aria-labelledby="modalLabel{{ $idx }}" aria-hidden="true"
                style="overflow: hidden !important;">
                <div class="modal-dialog modal-dialog-centered modal-fullscreen">
                    <div class="modal-content">
                        <div class="modal-header">
                            <img class="logo mx-0 align-content-center"
                                src="{{ $baseurl }}public/evamedia-asset/header-and-footer/evamedia-logo.png"
                                alt="">
                        ...
                        <div class="mb-5 pb-5" style="overflow: auto;">
                            <div class="modal-body">
                                ...
                                <div class="content-details pt-4 pb-4">
                                    <p class="modal-title fs-6 bold" id="modalLabel{{ $idx }}">
                                        {{ $item['by'] }}</p>
                                    <h1 class="modal-title fs-2 bold" id="modalLabel{{ $idx }}">
                                        {{ $item['title'] }}</h1>
                                    <hr>
                                    <p class="modal-title fs-5 bold" id="modalLabel{{ $idx }}">
                                        <?php echo $item['text-modal']; ?></p>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-6 col-lg-6 col-xl-6 d-flex align-items-center">
                                        <div class="content-text">
                                            ...
                                            <p class="c-696687">
                                                More than 3 years of high quality and dedicated service for digital
                                                marketing agency
                                            </p>
                                            <div class="row">
                                                <div class="col-12 col-lg-12 col-xl-12 d-flex align-items-left">
                                                    <div class="btn-hero mt-desk1 mr-desk1">
                                                        <a href="#formSendMail"
                                                            class="btn-coba nav-button-img bg-fff p-3 text-black brd-r-desk3"
                                                    ...
                                                    <div class="btn-hero mt-desk1 mr-desk1">
                                                        <a href="#formSendMail"
                                                            class="btn-coba nav-button-img bg-329FAF p-3 text-white brd-r-desk3">
                                                            TRY DEMO’S
                                                        </a>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-6 col-lg-6 col-xl-6">
                                        <div class="content-img w-100">
                                            <img src="{{ asset('' . $baseGD[$idx]['cover_modal2']) }}" alt=""
                                                srcset="" class="w-100">
                                        </div>
                                    </div>
                                </div>
    ...
    @foreach ($baseGD as $idx => $item)
        <section class="py-5 bg-form-img mobile-show" id="formSendMailMob" style="">
            <div class="modal fade" id="myModal-m{{ $idx }}" data-bs-backdrop="static"
                data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalLabel{{ $idx }}"
                aria-hidden="true" style="overflow: hidden !important;">
                <div class="modal-dialog modal-dialog-centered modal-fullscreen">
                    <div class="modal-content">
                        <div class="modal-header">
                            <img class="logo mx-0 align-content-center"
                        ...
                        <div class="mb-5 pb-5" style="overflow: auto;">
                            <div class="modal-body">
                                <img src="{{ asset('' . $baseGD[$idx]['cover_modal-mobile']) }}" alt=""
                                    class="w-100">
                                <div class="content-details pt-4 pb-4">
                                    <p class="modal-title m-by-m" id="modalLabel{{ $idx }}">{{ $item['by'] }}
                                    </p>
                                    <h1 class="modal-title m-title-m" id="modalLabel{{ $idx }}">
                                        {{ $item['title'] }}</h1>
                                    <hr>
                                    <p class="modal-title m-text-m" id="modalLabel{{ $idx }}">
                                        <?php echo $item['text-modal']; ?></p>
                                </div>
                            </div>
                            <div class="modal-body pt-3 pb-3">
                                <div class="row">
                                    <div class="col-12 col-lg-12 col-xl-12">
                                        <div class="content-img w-100">
                                            <img src="{{ asset('' . $baseGD[$idx]['cover_modal2-mobile']) }}"
                                                alt="" srcset="" class="w-100">
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-12 col-xl-12 d-flex align-items-center">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-lg-12 col-xl-12 d-flex align-items-left">
                                                    <div class="col-6 col-lg-6 col-xl-6 btn-hero mt-2 mr-desk1">
                                                        <a href="#formSendMail">
                                                            <img src="/evamedia-asset/modal/evamedia-btn1-mobile.png"
                                                                alt="" srcset="" class="w-90 ml-2">
                                                        </a>
                                                    </div>
                                                    <div class="col-6 col-lg-6 col-xl-6 btn-hero mt-2 ">
                                                        <a href="#formSendMail">
                                                            <img src="/evamedia-asset/modal/evamedia-btn2-mobile.png"
                                                                alt="" srcset="" class="w-90">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                @for ($idx = 0; $idx < count($baseGD); $idx++)
                                                    ...
                                                    <div class="col-6 col-md-6 col-lg-6 mb-3">
                                                        <!-- <div class="card-item w-25 px-3"> -->
                                                        <div class="card-item open-modal" data-toggle="modal"
                                                            data-target="#myModal-m{{ $idx }}">
                                                            <div class="row">
                                                                <div class="col-12 col-md-12 col-lg-12">
                                                                    <div class="cover-card">
                                                                ...
                                                                <div
                                                                    class="content-card d-flex justify-content-between mt-2">
                                                                    <div class="creator-content">
                                                                        <h1 class="modal-title mabout-title-m"
                                                                            id="modalLabel{{ $idx }}">
                                                                            {{ $item['title'] }}</h1>
                                                                        <p class="modal-title mabout-by-m"
                                                                            id="modalLabel{{ $idx }}">
                                                                            {{ $item['by'] }}</p>
                                                                    </div>
                                                                </div>
